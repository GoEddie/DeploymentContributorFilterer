...
namespace AgileSqlClub.SqlPackageFilter.IntegrationTests.VersionExecutorTests
{
    ...
    public class DacpacVersionTests
    {
        ...
        public void Schema_Is_Not_Dropped_When_Name_Is_Ignored()
        {
            ...
            var args =
            "/Action:Publish /TargetServerName:localhost /SourceFile:DacPac.dacpac  /TargetDatabaseName:Filters /p:DropObjectsNotInSource=True /p:AllowIncompatiblePlatform=true";
